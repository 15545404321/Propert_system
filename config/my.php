...
return [
	...
	//阿里云短信配置
	'ali_sms_accessKeyId'		=> 'LTAI5t8K3hVwoJ3qZ1ga9yM',				//阿里云短信 keyId	
	'ali_sms_accessKeySecret'	=> 'J4rAkx5BRrJRBROt4WvhV7VW1vjq',	//阿里云短信 keysecret
	...
	'ali_oss_accessKeySecret'	=> '4UI62NuZepUqetGtpPBbv2049El',					//阿里云短信 keysecret
	'ali_oss_endpoint'			=> 'http://i.whpj.vip',							//建议填写自己绑定的域名
	'ali_oss_bucket'			=> 'xhadmin',					
	
	//腾讯云cos配置
	'tencent_oss_secretId'		=> 'AKIDGMB24LXkbTUEtoSqxnMegRv84',				//腾讯云keyId	
	'tencent_oss_secretKey'		=> 'g5D5gz1LlO6YjFafSzFEwNXQ2N',		//腾讯云keysecret
	...
	//七牛云oss配置
	'qny_oss_accessKey' 		=> 'bm1sR9bxF5K7KYq2RtAhZJ8zOxb-HCGYx5pJU',  //access_key
	'qny_oss_secretKey' 		=> 'YrRaySbqu71IzZHOguJT0ObUdb7GBPRiYa7Lq',     //secret_key
	...
	'jwt_secrect'			=> 'boTCfOGKwqTNKArTboaTCfOGKawqTNKArTboTCfOGKwqTNKTboTCfOGKwqTNKArT',	//签名秘钥
	...
	'mini_program'			=> [
		...
		'secret' => '23d7191f4762197b835d',		//小程序secret
	],
	
	//公众号配置
	'official_accounts'		=> [
		'app_id'        => 'wxa2c835664852',												//公众号appid
		'secret'		=> '2d7ef1ddccd9e5e744',									//公众号secret
		'token'			=> 'chengdie',
	],
