Vue.component('Add', {
	template: `
		<el-drawer title="添加"  direction="rtl" size="1420px" class="icon-dialog" :visible.sync="show" @open="open" :before-close="closeForm" append-to-body>
			...
			<el-tabs v-model="activeName">
				...
				<el-tab-pane style="padding-top:10px"  label="项目信息" name="项目信息">
				<el-row >
					<el-col :span="24">
