Vue.component('Add', {
	template: `
		<div v-if="show">
			...
			<el-tabs v-model="activeName">
				...
				<el-tab-pane style="padding-top:10px"  label="单元信息" name="单元信息">
				<el-row >
					<el-col :span="24">
						<el-form-item label="单元数量" prop="louyu_dysl">
				...
				<el-row >
					<el-col :span="24">
						<el-form-item label="楼层总数" prop="louyu_lczs">
				...
				<el-row >
					<el-col :span="24">
						<el-form-item label="层户总数" prop="louyu_chzs">
							<el-input-number controls-position="right" style="width:200px;" autoComplete="off" v-model="form.louyu_chzs" clearable :min="0" placeholder="请输入层户总数"/>
						</el-form-item>
					</el-col>
				</el-row>
				<el-row >
					<el-col :span="24">
						<el-form-item label="负楼层数" prop="louyu_flcs">
							<el-input-number controls-position="right" style="width:200px;" autoComplete="off" v-model="form.louyu_flcs" clearable :min="0" placeholder="请输入负楼层数"/>
						</el-form-item>
					</el-col>
				</el-row>
				</el-tab-pane>
				<el-tab-pane style="padding-top:10px"  label="库商信息" name="库商信息">
				<el-row >
					<el-col :span="24">
						<el-form-item label="底商层数" prop="louyu_dscs">
							<el-input-number controls-position="right" style="width:200px;" autoComplete="off" v-model="form.louyu_dscs" clearable :min="0" placeholder="请输入底商层数"/>
						</el-form-item>
					</el-col>
				</el-row>
				<el-row >
					<el-col :span="24">
						<el-form-item label="一层几户" prop="louyu_ycjh">
							<el-input-number controls-position="right" style="width:200px;" autoComplete="off" v-model="form.louyu_ycjh" clearable :min="0" placeholder="请输入一层几户"/>
						</el-form-item>
					</el-col>
				</el-row>
				</el-tab-pane>
	...
	watch:{
		show(val){
			if(val){
				axios.post(base_url + '/Dyxx/getFieldList').then(res => {
	...
	methods: {
		...
		submit(){
			this.$refs['form'].validate(valid => {
				if(valid) {
					this.loading = true
					axios.post(base_url + '/Dyxx/add',this.form).then(res => {
						if(res.data.status == 200){
