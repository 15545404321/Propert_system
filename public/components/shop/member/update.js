Vue.component('Update', {
	...
	methods: {
		open(){
			this.form = this.info
			this.form.member_birthday = parseTime(this.form.member_birthday)
			this.setDefaultVal('member_idx')
			...
			this.form.member_fyqrrq = parseTime(this.form.member_fyqrrq)
			this.form.member_rhtzrq = parseTime(this.form.member_rhtzrq)
			this.strictly = true
