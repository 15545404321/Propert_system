Vue.component('Rzxinxi', {
	template: `
		<el-drawer title="入账信息"  direction="rtl" size="1500px" class="icon-dialog" :visible.sync="show" @open="open" :before-close="closeForm" append-to-body>
