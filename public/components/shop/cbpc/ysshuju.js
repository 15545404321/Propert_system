Vue.component('Ysshuju', {
	template: `
		<el-drawer title="应收数据"  direction="rtl" size="1500px" class="icon-dialog" :visible.sync="show" @open="open" :before-close="closeForm" append-to-body>
