Vue.component('Lsys', {
	template: `
		<el-drawer title="临时应收台账"  direction="rtl" size="1500px" class="icon-dialog" :visible.sync="show" @open="open" :before-close="closeForm" append-to-body>
	...
	methods: {
		open(){
			...
			this.jump = '/shop/Zjys/index?' + param(query)
		},
		closeForm(){
