Vue.component('Update', {
	...
	methods: {
		open(){
			this.form = this.info
			this.form.ryxx_addtime = parseTime(this.form.ryxx_addtime)
			this.setDefaultVal('ryxx_gzjg')
			this.setDefaultVal('ryxx_baoxian')
		},
		submit(){
			this.$refs['form'].validate(valid => {
				if(valid) {
					this.loading = true
					axios.post(base_url + '/Ryxx/update',this.form).then(res => {
