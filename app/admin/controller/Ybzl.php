...
/*
 module:		仪表种类控制器
 create_time:	2022-12-12 10:08:32
 author:		
 contact:		
*/
...
use app\admin\model\Ybzl as YbzlModel;
use think\facade\Db;
...
class Ybzl extends Admin {
 	...
 	*/
	function updateExt(){
		$postField = 'ybzl_id,ybzl_px';
		$data = $this->request->only(explode(',',$postField),'post',null);
		if(!$data['ybzl_id']) throw new ValidateException ('参数错误');
	...
	public function add(){
		...
		$this->validate($data,\app\admin\validate\Ybzl::class);
