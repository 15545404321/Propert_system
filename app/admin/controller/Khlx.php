...
/*
 module:		客户类型控制器
 create_time:	2022-12-16 16:21:31
 author:		
 contact:		
*/
...
use app\admin\model\Khlx as KhlxModel;
use think\facade\Db;
...
class Khlx extends Admin {
	...
	function updateExt(){
		...
		if(!$data['khlx_id']) throw new ValidateException ('参数错误');
	...
	public function add(){
		...
		$this->validate($data,\app\admin\validate\Khlx::class);
