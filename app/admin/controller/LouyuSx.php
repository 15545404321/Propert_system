...
/*
 module:		楼宇属性控制器
 create_time:	2022-12-08 13:45:53
 author:		
 contact:		
*/
...
use app\admin\model\LouyuSx as LouyuSxModel;
use think\facade\Db;
...
class LouyuSx extends Admin {
 	...
 	*/
	function updateExt(){
		$postField = 'louyusx_id,';
		$data = $this->request->only(explode(',',$postField),'post',null);
		if(!$data['louyusx_id']) throw new ValidateException ('参数错误');
	...
	public function add(){
		...
		$this->validate($data,\app\admin\validate\LouyuSx::class);
