...
use app\admin\model\IndexModule as IndexModuleModel;
use think\facade\Db;
...
class IndexModule extends Admin {
 	...
 	*/
	function updateExt(){
		$postField = 'indexmodule_id,';
		$data = $this->request->only(explode(',',$postField),'post',null);
		if(!$data['indexmodule_id']) throw new ValidateException ('参数错误');
	...
	public function add(){
		...
		$this->validate($data,\app\admin\validate\IndexModule::class);
