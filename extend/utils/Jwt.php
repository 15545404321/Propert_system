...
class Jwt
{
    ...
    public function validationToken()
    {
        ...
        try {
			...
			throw new HttpException(config('my.jwtErrorCode'),'token解析错误');
        }
        ...
        try {
            ...
            throw new HttpException(config('my.jwtErrorCode'),'签发错误');
        }
        ...
        try {
            ...
            throw new HttpException(config('my.jwtErrorCode'),'客户端错误');
        }
        ...
        try {
            ...
            throw new HttpException(config('my.jwtExpireCode'),'token过期');
        }
        ...
        try {
            ...
            throw new HttpException(config('my.jwtErrorCode'),'签名错误');
        }
